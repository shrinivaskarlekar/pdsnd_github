...
def get_filters():
    ...
    while True:
        city = input(
            'Would you like to explore data for, select City from {}? - '.format(', '.join(city_input).title())).lower()
    ...
    while True:
        month, day = None, None
        filter_input = input(
            'Would you like to filter the data by month, day, or both. Type "none" for no time filter? - ').lower()
...
def time_stats(df):
    ...
    print('The Most Frequent: \n\tMonth - {} \n\tDay of week - {} \n\tStart hour - {}'.format(freq_month, freq_day,
                                                                                              freq_hour))
...
def station_stats(df):
    ...
    print('The Most Popular Stations: \n\tStart Station - {} with Count {} \n\tEnd Station - {} with Count {}'.format(
        s_station, s_station_count, e_station, e_station_count))
    ...
    print('\nThe Most Popular trip with Count - {} : \n\tStart at - {} \n\tEnd at - {}'.format(trip_count, trip_start,
                                                                                               trip_end))
...
def trip_duration_stats(df, city, month, day):
    ...
    print('\tTotal Travel time - {} \n\tAvarage time - {}'.format(df['Trip Duration'].sum(skipna=True),
